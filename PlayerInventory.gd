...
var inventory = {
	0: ["Laser Drill", 1],  #--> slot_index: [item_name, item_quantity]
	1: ["Laser Drill", 1],  #--> slot_index: [item_name, item_quantity]
	2: ["Sandstone", 98],
	3: ["Sandstone", 45],
}
...
var equips = {
	0: ["Suit Upper", 1],  #--> slot_index: [item_name, item_quantity]
	1: ["Suit Lower", 1],  #--> slot_index: [item_name, item_quantity]
	2: ["Space Boots", 1],	
}
